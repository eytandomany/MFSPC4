...
You can find documentation there in the following files: README.PDF and document.pdf.

In the following folders there you can find examples for input and output files: 3Conc and ImageDist .
